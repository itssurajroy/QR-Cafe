      ...
      <div className="rounded-3xl border border-stone-200 bg-white p-5 space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></div>
            <h3 className="font-black text-stone-900 text-sm" style={{ fontFamily: "var(--font-heading)" }}>Live Order Feed</h3>
        ...
        {recentOrders.length === 0 ? (
          ...
          <div className="space-y-2">
            {recentOrders.map((o) => (
              <div key={o.id} className="flex items-center justify-between p-3 rounded-xl bg-white border border-stone-200">
                <div>
