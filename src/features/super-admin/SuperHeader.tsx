...
export function SuperHeader() {
  ...
  const titles: Record<string, string> = {
    ...
    restaurants: "Restaurants & Tenancy",
    cafes: "Restaurants & Tenancy",
    tenants: "Restaurants & Tenancy",
    outlets: "Restaurants & Outlets",
    subscriptions: "Subscription Accounts",
    billing: "Platform Billing & Invoices",
    orders: "Live Orders Stream",
    support: "Platform Support Desk",
    "system-health": "System Health & Monitoring",
    health: "System Health & Monitoring",
    jobs: "System Health & Jobs",
    integrations: "Platform Integrations Hub",
    admins: "Admins & Roles Governance",
    roles: "Admins & Roles Governance",
    users: "Admins & Roles Governance",
    audit: "Security & Platform Audit Logs",
    settings: "Platform Engine Settings",
    config: "Platform Engine Settings",
    "feature-flags": "Platform Engine Settings",
    broadcast: "Platform Engine Settings",
    announcements: "Platform Engine Settings",
    "api-keys": "Platform Engine Settings",
