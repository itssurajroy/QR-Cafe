      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[#FAF9F6] relative">
        ...
        >
          ...
          >
            ...
            <span className="text-[10px] font-bold mt-0.5 tracking-tight">Dashboard</span>
          </button>
          <button
            type="button"
            onClick={() => setTab("restaurants")}
            className={`flex-1 flex flex-col items-center justify-center py-1 rounded-xl transition-all touch-target ${
              tab === "cafes" || tab === "restaurants" || tab === "tenants" ? "text-[#5738F5]" : "text-slate-500 hover:text-slate-900"
            }`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
            </svg>
            <span className="text-[10px] font-bold mt-0.5 tracking-tight">Restaurants</span>
          </button>
          <button
            type="button"
          ...
          <button
            ...
            className={`flex-1 flex flex-col items-center justify-center py-1 rounded-xl transition-all touch-target ${
              tab === "system-health" || tab === "health" || tab === "jobs" ? "text-[#5738F5]" : "text-slate-500 hover:text-slate-900"
            }`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
