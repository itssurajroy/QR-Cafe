                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-xl text-xs font-bold border transition-colors cursor-pointer ${
                        auditActionFilter === act
                          ? "bg-indigo-600 text-slate-900 dark:text-white border-amber-400"
                          : "bg-slate-50 dark:bg-stone-950 border-slate-200 dark:border-stone-800 text-slate-500 dark:text-stone-400 hover:text-slate-900 dark:hover:text-white dark:text-white"
                      }`}
                    >
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs">
                  ...
                  <tbody className="divide-y divide-stone-800/60 font-mono text-xs">
                    {auditRows.map((a: any) => (
                      <tr key={a.id} className="hover:bg-slate-100 dark:hover:bg-stone-800 dark:bg-stone-800/30">
