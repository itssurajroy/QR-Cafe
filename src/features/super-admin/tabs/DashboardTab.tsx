...
{/* TAB 1: DASHBOARD & RECHARTS ANALYTICS */}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-6 gap-3">
                ...
                <div className="p-4 rounded-2xl bg-white dark:bg-stone-900 border border-emerald-200 space-y-1">
                ...
                <div className="p-4 rounded-2xl bg-white dark:bg-stone-900 border border-amber-900/50 space-y-1">
                  ...
                  <table className="w-full text-left text-xs">
                    ...
                    <tbody className="divide-y divide-stone-800/60">
                      {charts.topCafes.map((c: any, idx: number) => (
                        <tr key={c.id} className="hover:bg-slate-100 dark:hover:bg-stone-800 dark:bg-stone-800/30 transition-colors">
                          ...
                          <td className="py-3 text-right">
                            <button
                              ...
                              className="px-3 py-2.5 min-h-[44px] rounded-lg bg-slate-100 dark:bg-stone-800 hover:bg-slate-200 dark:hover:bg-stone-700 text-indigo-600 font-bold text-xs cursor-pointer"
                            >
                              Inspect &rarr;
                            </button>
                          </td>
