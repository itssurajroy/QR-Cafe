...
export function CommandPalette() {
  ...
  const staticActions: Action[] = [
    { id: "new-tenant", label: "New restaurant…", hint: "Provision", run: () => { setShowNewCafeModal(true); setOpen(false); setQuery(""); } },
    { id: "go-dashboard", label: "Go to Dashboard", hint: "Overview", run: () => go("dashboard") },
    { id: "go-restaurants", label: "Go to Restaurants", hint: "Platform", run: () => go("restaurants") },
    { id: "go-subscriptions", label: "Go to Subscriptions", hint: "Platform", run: () => go("subscriptions") },
    { id: "go-billing", label: "Go to Billing", hint: "Platform", run: () => go("billing") },
    { id: "go-orders", label: "Go to Live Orders", hint: "Platform", run: () => go("orders") },
    { id: "go-support", label: "Go to Support", hint: "Operations", run: () => go("support") },
    { id: "go-health", label: "Go to System Health", hint: "Infrastructure", run: () => go("system-health") },
    { id: "go-integrations", label: "Go to Integrations", hint: "Infrastructure", run: () => go("integrations") },
    { id: "go-admins", label: "Go to Admins & Roles", hint: "Governance", run: () => go("admins") },
    { id: "go-audit", label: "Go to Audit Logs", hint: "Governance", run: () => go("audit") },
    { id: "go-settings", label: "Go to Settings", hint: "Governance", run: () => go("settings") },
  ];
