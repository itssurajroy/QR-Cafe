...
export function TenantSlideOver() {
  ...
  const { drawerCafeId, setDrawerCafeId, drawerData, loadingDrawer, drawerTab, setDrawerTab, openDrawer, handleSetPlan, handleExtendTrial, handleMarkPaid, handleAddRefundNote, handleDeleteCafe } = ctx;
