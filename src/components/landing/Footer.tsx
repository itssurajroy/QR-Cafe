        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-4 flex gap-4">
              <a href="#" className="text-slate-400 transition-colors hover:text-slate-700" aria-label="Instagram">
              ...
              <a href="#" className="text-slate-400 transition-colors hover:text-slate-700" aria-label="Twitter">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                </svg>
              </a>
              <a href="#" className="text-slate-400 transition-colors hover:text-slate-700" aria-label="LinkedIn">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="/onboarding" className="text-sm text-slate-500 transition-colors hover:text-slate-900">
                  Get Started
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <a href="#faq" className="text-sm text-slate-500 transition-colors hover:text-slate-900">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <Link href="/legal/terms" className="text-sm text-slate-500 transition-colors hover:text-slate-900">
                  Terms
                </Link>
              </li>
              <li>
                <Link href="/legal/privacy" className="text-sm text-slate-500 transition-colors hover:text-slate-900">
                  Privacy
                </Link>
              </li>
              <li>
                <Link href="/legal/refund" className="text-sm text-slate-500 transition-colors hover:text-slate-900">
                  Refund
                </Link>
              </li>
              <li>
                <Link href="/legal/cookies" className="text-sm text-slate-500 transition-colors hover:text-slate-900">
                  Cookies
                </Link>
              </li>
            </ul>
